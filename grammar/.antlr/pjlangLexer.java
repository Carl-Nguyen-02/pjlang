...
public class pjlangLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"T__0", "T__1", "T__2", "T__3", "T__4", "T__5", "T__6", "IF", "ELIF", 
			"ELSE", "WHILE", "DEF", "PRINT", "RETURN", "BREAK", "CONTINUE", "EQUAL", 
			"AND", "EQEQUAL", "NOTEQUAL", "LESS", "GREATER", "LESSEQUALEQUAL", "GREATEREQUAL", 
